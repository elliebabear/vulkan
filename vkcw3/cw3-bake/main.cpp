...
namespace
{
	 ...
	 */
	constexpr char kTextureFallbackR1[] = "assets-src/cw3/r1.png";
	constexpr char kTextureFallbackRGBA1111[] = "assets-src/cw3/rgba1111.png";
	constexpr char kTextureFallbackRGB000[] = "assets-src/cw3/rgb000.png";
...
#	endif
	process_model_(
		"assets/cw3/suntemple.comp5822mesh",
		"assets-src/cw3/suntemple.obj-zstd"
	);
...
namespace
{
	std::unordered_map<std::string,TextureInfo_> find_unique_textures_( InputModel const& aModel )
	{
		...
		for( auto const& mat : aModel.materials )
		{
			...
			add_unique_( mat.emissiveTexturePath, 4 );  // srgb only, but make it easy to distinguish from the non-srgb normal map
		}
